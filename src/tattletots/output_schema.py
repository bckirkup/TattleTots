...
class TimeSeries(BaseModel):
    ...
    n_attention_solvent_agents: list[int] = Field(default_factory=list)
    n_attention_eligible_agents: list[int] = Field(default_factory=list)
    attention_carrying_capacity: list[float] = Field(default_factory=list)
    grounded_info_yield: list[float] = Field(default_factory=list)
    ungrounded_info_yield: list[float] = Field(default_factory=list)
    grounded_yield_share: list[float] = Field(default_factory=list)
    effective_grounded_info_yield: list[float] = Field(default_factory=list)
    effective_ungrounded_info_yield: list[float] = Field(default_factory=list)
    effective_grounded_yield_share: list[float] = Field(default_factory=list)
