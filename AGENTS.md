...
- **Residual streams are capped at `config.max_input_dim`** (default 30) to prevent exponential blowup
...
- Dimensionality cap (`max_input_dim`) on inputs/residuals prevents exponential vector growth; tunable per scenario
